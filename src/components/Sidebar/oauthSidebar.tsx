...
import { FiHome, FiTrendingUp, FiCompass, FiStar, FiSettings, FiMenu, FiBell } from "react-icons/fi";
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: "Meetings", icon: FiTrendingUp, path: "/meeting" },
];
...
function MobileNav({ onOpen, ...rest }: MobileProps) {
  return (
    <Flex
      ...
      {...rest}
    >
      <Flex alignItems="center" width="260px" justifyContent="center"></Flex>
      <IconButton
